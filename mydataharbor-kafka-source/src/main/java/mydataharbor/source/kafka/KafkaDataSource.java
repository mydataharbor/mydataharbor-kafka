 ...
 **/
@Slf4j
public class KafkaDataSource extends AbstractRateLimitDataSource<ConsumerRecord<String, String>, BaseSettingContext> {

  protected KafkaConsumer<String, String> kafkaConsumer;

  public KafkaDataSource(KafkaDataSourceConfig simpleKafkaConfig) {
